...
const teamDetails = {
    "1": {teamMission: missions[1], art: "👨‍🚀", abilities: "Invisibility; Blink; EMP Bomb", desc: "Human Covert Unit"},
    "2": {teamMission: missions[2], art: "👽", abilities: "Capture; Invisibility, Blink", desc: "Alien Sentry Unit"},
    "0": {teamMission: missions[3], art: "?", abilities: "Not set", desc: "Not set"}
};